...
extern uint8_t DS18X20_start_meas( uint8_t with_power_extern, uint8_t id[]);
extern uint8_t DS18X20_read_decicelsius_single( uint8_t familycode, int16_t *decicelsius );
extern uint8_t DS18X20_format_from_decicelsius( int16_t decicelsius, char str[], uint8_t n);
#endif
